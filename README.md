...
either the [Django API Boilerplate](https://github.com/timmshinbone/django-auth-api-boilerplate)
or the [Express API Template](https://github.com/timmshinbone/express-mongoose-auth-api-boilerplate).
